...
packetResponse_t response[] = {
    ...
    {0,  NULL, 0,  NULL, NULL},                 //Get all Sonars
    {0,  NULL, 0,  NULL, toggleLED},            //Set FNR
    {0,  NULL, 0,  NULL, toggleLED2},           //Set Throttle  
    {0,  NULL, 0,  NULL, NULL},                 //Set Speed
    {0,  NULL, 0,  NULL, NULL},                 //Get Speed
    {0,  NULL, 0,  NULL, toggleLED3},           //Set Steering
    {0,  NULL, 0,  NULL, NULL},                 //Get Steering Angle
    {0,  NULL, 0,  NULL, NULL},                 //Set Lights
    {0,  NULL, 0,  NULL, NULL},                 //Get Battery
    {0,  NULL, 0,  NULL, NULL}                  //Send Stop
};
